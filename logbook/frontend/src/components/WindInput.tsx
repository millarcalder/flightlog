...
const WindInput: FC<IProps> = (props) => {
    ...
    return <>
        <input {...props} type='range' min={0} max={360} defaultValue={0} onChange={(e) => {
        ...
        >
            <circle r={117.5} cx={120} cy={120} style={{ fill: 'none', stroke: 'gray', strokeWidth: 0.5 }} />
            <g transform-origin='20 115' transform={`translate(100 5) rotate(${windDir + 180})`}>
                <path
