...
from flightlog.lib.igc_parser import parse_igc_str


test_file_path = f'{Path(os.path.dirname(os.path.realpath(__file__))).parent}/data/220415234416.igc'
